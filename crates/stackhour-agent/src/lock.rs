...
//! a signal-free process probe where ONLY ESRCH means dead (EPERM = alive); one
...
fn pid_is_alive(pid: u32) -> bool {
    ...
    match rustix::process::test_kill_process(pid) {
        ...
        // EPERM and any indeterminate platform error do not prove that the
        // process is dead. Treat them as alive to preserve lock safety.
        Ok(()) | Err(_) => true,
    }
}
